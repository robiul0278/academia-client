...
const InstructorCard = ({person}) => {
    return (
<div
      className="bg-white p-6 shadow-[0_4px_12px_-5px_rgba(0,0,0,0.4)] w-full max-w-sm rounded-2xl font-[sans-serif] overflow-hidden mx-auto mt-4">
      <div className="flex flex-col items-center">
        <div className="min-h-[110px]">
          <img src={person?.image} className="w-20 h-w-28 rounded-full" />
        </div>

        <div className="mt-4 text-center">
          <p className="text-lg text-gray-800 font-bold">{person?.name}</p>
